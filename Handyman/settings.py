...
SECRET_KEY = 'uce2&#bap4&=)a6t7-1)(#k+_0q2iw=-!%_pnegdq74_5aqfc%'
...
TEMPLATES = [
    {
        ...
        'DIRS': [TEMPLATE_DIR, MISCELLANEOUS_DIR],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_HOST_USER = 'handymanservicesltd3@gmail.com'
EMAIL_HOST_PASSWORD = 'handyMan@123'
EMAIL_PORT = 587
